...
<body>
  ...
  <ul class="main-menu clearfix">
	...
	<img  id="star" src="img/starter.jpg" onclick="window.open('starterdb.jsp');" >

	</figure>
	<figure>
	<h3 id="veg">Veg</h3>
	<img  id="vegdish" src="img/veg.jpg" onclick="window.open('vegdb.jsp');" >
	</figure>
	<figure>
	<h3 id="non-veg">Non-Veg</h3>
	<img  id="non-vegdish" src="img/non-veg.jpg" onclick="window.open('non-vegdb.jsp');" >
	</figure>
	<figure>
	<h3 id="dessert">Desserts</h3>
	<img  id="des" src="img/dessert.jpeg" onclick="window.open('dessertdb.jsp');" >
	</figure>
	</div>
